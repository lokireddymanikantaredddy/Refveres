...
const Cpp = () => {
  const [activeSection, setActiveSection] = useState(cppContent.sections[0]?.id || 'getting-started');
  ...
  return (
    <div className="min-h-screen dark:bg-[#0d1117] bg-white py-8" >
      <div className="max-w-7xl mx-auto px-4">
        <PageHeader
          title={cppContent.title}
          icon={cppContent.icon}
          description={cppContent.description}
          color={cppContent.color}
        />
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-9">
            {cppContent.sections.map((section) => (
              <div
                key={section.id}
                id={section.id}
                className="mb-12"
