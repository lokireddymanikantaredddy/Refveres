  ...
  return (
    <div className="min-h-screen dark:bg-[#0d1117] bg-white py-8">
      <div className="max-w-7xl mx-auto px-4">
        <PageHeader
          title={jqueryContent.title}
          icon={jqueryContent.icon}
          description={jqueryContent.description}
          color={jqueryContent.color}
        />
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-3">
            <SideNavigation
              sections={jqueryContent.sections}
          ...
          <div className="col-span-9">
            {jqueryContent.sections.map((section) => (
              <div
                key={section.id}
                id={section.id}
                className="mb-12"
