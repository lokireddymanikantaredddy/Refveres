    ...
    <div className="min-h-screen dark:bg-[#0d1117] bg-white py-8">
      <div className="max-w-7xl mx-auto px-4">
        <PageHeader
          ...
          icon={expressContent.icon}
          description={expressContent.description}
          color={expressContent.color}
        />
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-3">
            <SideNavigation
              sections={expressContent.sections}
          ...
          <div className="col-span-9">
            {expressContent.sections.map((section) => (
              <div
                key={section.id}
                id={section.id}
                className="mb-12"
