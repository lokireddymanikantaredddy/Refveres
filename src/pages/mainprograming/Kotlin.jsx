...
const Kotlin = () => {
  const [activeSection, setActiveSection] = useState(kotlinContent.sections[0]?.id || 'getting-started');
    ...
    <div className="min-h-screen dark:bg-[#0d1117] bg-white py-8" >
      <div className="max-w-7xl mx-auto px-4">
        <PageHeader
          ...
          icon={kotlinContent.icon}
          description={kotlinContent.description}
          color={kotlinContent.color}
        />
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-3">
            <SideNavigation
              sections={kotlinContent.sections}
          ...
          <div className="col-span-9">
            {kotlinContent.sections.map((section) => (
              <div
                key={section.id}
                id={section.id}
                className="mb-12"
